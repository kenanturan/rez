...
class UIManager: UIViewController {
    ...
    func setupLogoImageView() -> UIImageView {
    ...
    func setupAdminUI() {
        ...
        userAddButton.addTarget(self, action: #selector(ViewController.goToAddUser), for: .touchUpInside)
        ...
        viewReservedUsersButton.addTarget(self, action: #selector(ViewController.viewReservedUsers), for: .touchUpInside)
        ...
        listButton.addTarget(self, action: #selector(ViewController.goToCoursesList), for: .touchUpInside)
        ...
        reservationsButton.addTarget(self, action: #selector(ViewController.goToReservations), for: .touchUpInside)
